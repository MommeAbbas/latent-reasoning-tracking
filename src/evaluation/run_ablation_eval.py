...
def run_ablation_seed(seed, true_dyn, sensors, predictor):
    np.random.seed(seed)

    no_rot_dyn   = make_no_rotation_dynamics(true_dyn.cfg)
    two_mode_dyn = make_two_mode_dynamics(true_dyn.cfg)
